    ...
    return (
        <div className={style.mainTest} style={props.style}>
            ...
            <div className={style.pos}>
                <BlockInput gridName={"A"} type={'text'} text={"Характер груза"} placeholder={"Описание..."} require={false} name={"descriptionCargo"} onChange={(e) => onChangeDefault(e, cargoContent, setCargoContent)}/>
                ...
                <BlockInput gridName={"D"} type={'select'} text={"Пункт доставки"} placeholder={"Не выбран"} selectArray={selectArray} require={false} name={"end"} onChange={(e) => onChangeDefault(e, cargoContent, setCargoContent)}/>
            </div>
        </div>
    )
}